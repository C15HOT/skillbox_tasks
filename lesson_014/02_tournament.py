...
# TODO Хм, одну ошибку вы пропустили, вернее обработали только один частный случай
# ### Tour 1
...
# winner is Ринат
# TODO Обратите внимание на различие этих 2 выводов
# ### Tour 1
# Антон	1/6/1/--327-18812382     Недопустимая комбинация фрейма - «82»
# TODO У вас эта строка считается верной, хотя в конце стоит 82 - фрейм, где сбиты 10 кеглей, но нету spare
# Елена	3532X332/3/62--62X       105
